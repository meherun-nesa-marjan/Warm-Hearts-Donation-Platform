                ...
                <div className="hero-content text-center">
                    <div className="">
                        ...
                        <div className="border mx-5 p-5 bg-[#137257] text-white rounded-xl">
                               ...
                               <p>W.Clothing Donation was founded with a view to helping the destitute people living around us with the basic necessities of human life. W.Clothing Donation helps them as a relative helps us in our time of emergency.</p>
                            </div>
                            <div className="border mx-5 p-5 bg-[#137257] text-white rounded-xl">
